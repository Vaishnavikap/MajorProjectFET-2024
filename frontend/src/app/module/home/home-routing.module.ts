...
const routes: Routes = [
  ...
  { path: 'library', loadChildren: () => import('../../module/library/library.module').then(m => m.LibraryModule) }, 
  { path: 'playlist', loadChildren: () => import('../../module/playlist/playlist.module').then(m => m.PlaylistModule) }, 
  { path: 'premium', loadChildren: () => import('../../module/premium/premium.module').then(m => m.PremiumModule) }
